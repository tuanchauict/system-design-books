...
![](https://www.hellointerview.com/_next/static/89dbb1659807ca310b05c3f33bfc61c0.svg)
...
Composite indexes are the most common optimization pattern you'll encounter in practice. Instead of creating separate indexes for each column, we create a single index that combines multiple columns in a specific order. This matches how we typically query data in real applications.Consider a typical social media feed query:```sql
SELECT * FROM posts 
WHERE user_id = 123 
...
We could create two separate indexes:```scdoc
